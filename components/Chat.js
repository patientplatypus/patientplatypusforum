...
class ChatContext extends Component{
  ...
  render(){
    return(
      <div className='chat'>
        <div style={{height: '1rem', width: '100%', margin: 'auto', textAlign: 'center', fontWeight: 'bold'}}>
          Chat
        </div>
        <div style={{height: 'calc(60vh - 2rem - 15px)', background: 'rgb(123, 146, 180)', padding: '5px'}}>
        ...
        <div style={{width: '100%', position: 'absolute', bottom: 0, left: 0}}>
          <div style={{display: 'flex', flexDirection: 'row'}}>
            <div style={{flex: 1, fontWeight: 'bold', marginLeft: '5px', textAlign: 'left'}}>
