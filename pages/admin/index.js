            ...
            <div>
              ...
              <div>
                ...
                {renderIf(this.state.creatingBlogPost)(
                  <div style={{border: '5px solid black', width: '100%', marginTop: '5px'}}>
                    ...
                    <div style={{width: 'calc(100% - 10px)', border: '2px solid black', marginTop: '5px', marginBottom: '5px', paddingLeft: '5px', paddingRight: '5px'}}>
                      <div 
                      className='button'
